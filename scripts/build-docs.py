...
names=['ARCHITECTURE','RELEASING','VERIFICATION','VERIFICATION-0.4','PERFORMANCE','WEBSITE-QA','ACKNOWLEDGMENTS','DOMAIN','ROADMAP-100','VERIFICATION-0.5','STORE-FOUNDATIONS','GOVERNANCE','ENGINE-ARCHITECTURE','IDENTITY-RESEARCH','PRODUCT-ROADMAP','CLI']
def shell(title,body,url):
    description=html.escape(f'{title}: Prepare image-to-PDF documentation, local processing details and release evidence. Versioned reports retain their original scope.')
