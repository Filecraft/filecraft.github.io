...
names=['SIGNING','AUTO-FIT','MIGRATION','AI-DISCLOSURE','ONLINE-ASSISTANCE','DOCUMENTATION-HOSTING','ARCHITECTURE','RELEASING','VERIFICATION','VERIFICATION-0.4','PERFORMANCE','WEBSITE-QA','ACKNOWLEDGMENTS','DOMAIN','ROADMAP-100','VERIFICATION-0.5','STORE-FOUNDATIONS','GOVERNANCE','ENGINE-ARCHITECTURE','IDENTITY-RESEARCH','PRODUCT-ROADMAP','CLI','PDF-WORKFLOWS','DEPENDENCIES','DESIGN-SYSTEM','PLATFORM-QUALIFICATION','DESKTOP-SUITE']
import runpy
...
for name in names:
    ...
    def target(m):
        ...
        elif path.startswith('../'):url='https://github.com/Filecraft/Filecraft/blob/main/'+path.removeprefix('../')+(sep+fragment if sep else '')
        else:url='../'+url
        return 'href="'+url+'"'
